...
- **NLP**: embeddings, RNN, BERT, T5, Transformers
#### :computer: Programming and Development
- **Languages**: Python, C++ (primary), R, SQL, Bash (but also Kotlin, C#, Java)
- **Libraries**: PyTorch, Scikit-learn, Optuna, CatBoost, Transformers, Diffusers, YOLO
...
- **MLFlow + AirFlow, ClearML**
- **CI/CD**: Gitlab CI/CD
- **Other**: Triton, vLLM, ONNX-Runtime, TensorRT-LLM
...
|Deep Learning School MIPT, 1 semester|02.2024 - 06.2024|[Certificate](https://drive.google.com/drive/u/0/folders/1dhK506K7hItWnnvbpTnuNhgxGDiknFGH)|
